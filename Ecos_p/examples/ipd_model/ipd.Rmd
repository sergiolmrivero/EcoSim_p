---
title: "Iterater Prisioner's Dilemma"
...
### Here we run the simulation - This chunk just execute the python programa
### For a more integrated approach you can use reticulate

system("rm runs/*.csv")

system("python3 ipd.py")
