...
PATH_TO_MODEL = '/home/rivero/Dropbox/Workspace_Current/Projects/Applications/EcoSim/EcoSim_p/src/EcoSim_p/Ecos_p/examples/el_farol_bar_model/'
...
model_config = PATH_TO_MODEL + 'el_farol_bar_model_config.json'
model_defs = PATH_TO_MODEL + 'el_farol_bar.json'
efb_sim = sim.Simulation(model_config, model_defs )

efb_sim.execute_simulation()
